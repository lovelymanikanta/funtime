(function($){
    ...
    // Typing animation for website name with 2-second delay
    setTimeout(function() {
        var websiteName = "WelCome FunTime India"; 
        var textElement = document.getElementById("websiteName");
        ...
        function typeWriter() {
            if (index < websiteName.length) {
                ...
                textElement.innerHTML += websiteName.charAt(index);
                index++;
